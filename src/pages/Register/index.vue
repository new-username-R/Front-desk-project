  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        />
        <button
          style="width: 100px; height: 38px; line-height: 38px"
          @click="getCode"
        >
          获取验证码
        </button>
      ...
      <div class="btn">
        <button @click="confiRegister">完成注册</button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getCode() {
      try {
        let code = await this.$store.dispatch("getCode", this.userInfo.phone);
    ...
    // 确认注册
    async confiRegister() {
      const { phone, password, confirmPassword, code } = this.userInfo;
